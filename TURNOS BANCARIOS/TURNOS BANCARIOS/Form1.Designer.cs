namespace TURNOS_BANCARIOS
{
   partial class Form1
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.pictureBox1.Size = new System.Drawing.Size(295, 118);
         ...
         this.panelTop.Size = new System.Drawing.Size(773, 90);
         ...
         this.label2.Text = "Sistema Automatizado Para la Toma de Deciciones";
         // 
         // timer1
         // 
         ...
         this.label3.Text = "¡Presiona la Tecla Enter para Comenzar!";
         // 
         // Form1
         // 
